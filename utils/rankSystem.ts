...
export const RANKS: Rank[] = [
  { name: "INITIATE", icon: "M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0 M12 2v2M12 20v2M2 12h2M20 12h2 M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0", color: "text-zinc-500" },
  { name: "SCOUT", icon: "M20 7h-4V4c0-1.1-.9-2-2-2h-4c-1.1 0-2 .9-2 2v3H4c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2zM10 4h4v3h-4V4z", color: "text-blue-400" },
  { name: "RANGER", icon: "M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z", color: "text-emerald-400" },
  { name: "OPERATOR", icon: "M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5", color: "text-cyan-400" },
  { name: "COMMANDER", icon: "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10zM9 12l2 2 4-4", color: "text-indigo-400" },
  { name: "SENTINEL", icon: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z", color: "text-amber-400" },
  { name: "WARLORD", icon: "M6 9l6-7 6 7-6 13-6-13z", color: "text-fuchsia-500" },
  { name: "SOVEREIGN", icon: "M2 4l3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14", color: "text-yellow-500" }
];

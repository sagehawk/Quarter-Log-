  ...
  const personas: { id: AIPersona; name: string; desc: string; requiredStreak: number; icon: React.ReactNode }[] = [
    {
      id: 'LOGIC',
      name: 'The Strategist',
      desc: 'Cold, calculated, and objective. Focuses on data and next steps.',
      requiredStreak: 0,
    ...
    },
    {
      id: 'AGGRESSIVE',
      name: 'The Commander',
      desc: 'Ruthless accountability. No excuses. High intensity feedback.',
      requiredStreak: 7,
    ...
    },
    {
      ...
      desc: 'Focuses on control, virtue, and long-term perspective.',
      requiredStreak: 14,

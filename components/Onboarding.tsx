...
const Onboarding: React.FC<OnboardingProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-black overflow-y-auto custom-scrollbar">
      
      {/* Cinematic Background - REMOVED GRADIENT */}
      ...
      <div className="min-h-full flex flex-col items-center justify-center p-6 py-24 text-center font-sans text-white relative">
        ...
        <div className="absolute top-12 left-0 w-full flex justify-center gap-1.5 safe-top z-20 px-10">
            {[1, 2, 3, 4, 5].map(i => (
                <div key={i} className={`h-1 rounded-full transition-all duration-700 ease-out ${i <= step ? 'flex-1 bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.5)]' : 'flex-1 bg-white/5'}`} />
            ))}
        </div>
            ...
            <div className="space-y-10 animate-fade-in">
                <div className="space-y-2">
                    <h1 className="text-6xl font-black italic uppercase tracking-tighter leading-[0.8] text-transparent bg-clip-text bg-gradient-to-b from-white to-white/50">
                        7-Day<br/><span className="text-green-500">Reset</span>
                    </h1>
                </div>
                ...
                <div className="space-y-6 text-left px-2">
                    ...
                    <div className="pl-4 border-l-2 border-green-500/50 space-y-4">
                ...
                <button onClick={handleNext} className="w-full py-5 bg-white hover:bg-green-500 text-black font-black uppercase tracking-[0.2em] rounded-xl transition-all shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(34,197,94,0.4)] text-lg animate-slide-up">
                    Accept Challenge
                </button>
            </div>
        )}
        ...
        {step === 2 && (
            <div className="space-y-10 animate-fade-in">
                ...
                <div className="flex flex-col gap-6 text-left px-4">
                    <div className="bg-white/5 p-6 rounded-3xl border border-white/5 space-y-6">
                        ...
                        <div className="flex items-baseline gap-4">
                            <span className="text-green-500 font-black text-4xl italic tracking-tighter">01</span>
                            <div>
                        ...
                        <div className="flex items-baseline gap-4">
                            <span className="text-green-500 font-black text-4xl italic tracking-tighter">02</span>
                            <div>
                ...
                <button onClick={handleNext} className="w-full py-6 bg-white hover:bg-green-500 text-black font-black uppercase tracking-[0.2em] rounded-xl transition-all shadow-2xl text-xl">
                    Understood
                </button>
            </div>
        )}
            ...
            <div className="space-y-12 animate-fade-in">
                <div className="text-center space-y-4">
                    <h1 className="text-6xl font-black italic uppercase tracking-tighter leading-none">
                        Sync<br/><span className="text-green-500">Cycle</span>
                    </h1>
                </div>
                ...
                <div className="bg-white/5 p-10 rounded-[3rem] border border-white/10 space-y-10">
                    <div className="space-y-4">
                        <input 
                            ...
                            className="w-full bg-black/50 text-white font-black text-5xl p-6 rounded-2xl border border-white/10 focus:border-green-500 outline-none transition-all text-center italic"
                        />
                    ...
                    <div className="pt-4 border-t border-white/5">
                        <div className="text-4xl font-black text-white italic tracking-tighter">
                            {calculateTotalBlocks()} <span className="text-xl text-green-500">Cycles</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="space-y-10 animate-fade-in">
                <div className="text-center space-y-4">
                    <h1 className="text-5xl font-black italic uppercase tracking-tighter leading-none">
                        North<br/><span className="text-green-500">Star</span>
                    </h1>
                ...
                <div className="bg-white/5 p-6 rounded-[2rem] border border-white/10 space-y-4">
                     <textarea
                        ...
                        className="w-full bg-black/50 text-white font-bold text-xl p-6 rounded-2xl border border-white/10 focus:border-green-500 outline-none transition-all italic min-h-[120px]"
                        autoFocus
                     />
                </div>
                ...
                <div className="space-y-4">
                    <button 
                        ...
                        className={`w-full py-6 bg-white hover:bg-green-500 text-black font-black uppercase tracking-[0.2em] rounded-xl transition-all shadow-2xl text-xl ${!priority.trim() ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
                        Set Priority
                    </button>
                    <button 
        ...
        {step === 5 && (
            <div className="space-y-12 animate-fade-in flex flex-col items-center">
                <div className="relative">
                    ...
                    <div className="w-32 h-32 bg-green-500 rounded-[2.5rem] flex items-center justify-center text-black shadow-[0_0_60px_rgba(34,197,94,0.6)] relative z-10">
                ...
                <div className="text-center space-y-4">
                    <h1 className="text-5xl font-black italic uppercase tracking-tighter leading-none">
                        Arm The<br/><span className="text-green-500">System</span>
                    </h1>
                    <p className="text-white/60 font-bold text-base leading-relaxed max-w-xs mx-auto">
                ...
                <button 
                    ...
                    className="w-full py-6 bg-green-500 hover:bg-white text-black font-black uppercase tracking-[0.25em] rounded-2xl shadow-[0_0_40px_rgba(34,197,94,0.4)] transition-all scale-105 active:scale-95 text-xl animate-pulse-slow"
                >
                    Authorize
                </button>

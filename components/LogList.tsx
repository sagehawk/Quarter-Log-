          ...
          <div className="space-y-0 relative border-l border-white/5 ml-3">
            {groupedLogs[date].map((log, index) => {
              ...
              return (
                ...
                >
                  {/* Timeline Node */}
                  <div className={`absolute left-[-5px] top-8 w-2.5 h-2.5 rounded-full border-2 transition-all duration-300 ${isWin ? 'border-zinc-800 bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.4)] group-hover:scale-125' : 'border-zinc-800 bg-red-500 shadow-[0_0_10px_rgba(220,38,38,0.4)]'}`} />

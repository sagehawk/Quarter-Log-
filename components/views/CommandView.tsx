            ...
            <section className="group">
                {isEditingPriority ? (
                    ...
                    >
                        ...
                        <div className={`text-2xl font-black italic tracking-tighter leading-none relative z-10 ${strategicPriority ? (isDark ? 'text-white' : 'text-zinc-900') : (isDark ? 'text-white/20' : 'text-zinc-300')}`}>
